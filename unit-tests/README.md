...
1. En su IDE preferido, abrir el codigo del proyecto cats-shelter-back

1. Crear el paquete `com.shelter.animalback.unit.service`

1. Crear la clase `AnimalServiceImpTest`, con el siguiente contenido:
...
1. Crear el paquete `com.shelter.animalback.unit.controller`

1. Crear la clase `AnimalControllerTest`, con el siguiente contenido:
